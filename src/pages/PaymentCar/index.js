...
import { faCheck, faUserGroup, faArrowLeft } from '@fortawesome/free-solid-svg-icons';
...
const PaymentCar = () => {
	...
	const { id } = useParams();
	const SEARCH_URL = `https://bootcamp-rent-cars.herokuapp.com/admin/car/${id}`;
				...
				<div className="hero-pay-div">
					<div className="pay-back">
						<StyledTooltip title="Kembali ke halaman sebelumnya">
							<button onClick={() => navigate(`/cars/${id}`)} style={{ cursor: 'pointer' }} id="backBtn">
							...
							<Form className="form-pesan">
								...
								<div className="title-pesan">
									<Form.Group controlId="namaMobil" className="isi-pesan ">
										...
										<Form.Label className="text-capitalize text-black-50">{car.name}</Form.Label>
									</Form.Group>
							...
							<div className="select-bank">
								<Card className="card-bank-detail">
									<Card.Body className="d-flex flex-column">
										<Card.Title className="fw-bold mb-4">Pilih Bank Transfer</Card.Title>
										<Card.Text>
											Kamu bisa membayar dengan transfer melalui ATM, Internet Banking, atau
											Mobile Banking
										</Card.Text>
										<a className="btn-bank" onClick={(e) => handleClickBank(e, 'BCA')}>
											<div className="tmbl">BCA</div>
											<div className="tmbl-text">BCA Transfer</div>
											{isCheck1 && <FontAwesomeIcon icon={faCheck} className="ico" />}
										</a>
										<a className="btn-bank" onClick={(e) => handleClickBank(e, 'BNI')}>
											<div className="tmbl">BNI</div>
											<div className="tmbl-text">BNI Transfer</div>
											{isCheck2 && <FontAwesomeIcon icon={faCheck} className="ico" />}
										</a>
										<a className="btn-bank" onClick={(e) => handleClickBank(e, 'Mandiri')}>
											<div className="tmbl">Mandiri</div>
											<div className="tmbl-text">Mandiri Transfer</div>
											{isCheck3 && <FontAwesomeIcon icon={faCheck} className="ico" />}
										</a>
									</Card.Body>
								</Card>
